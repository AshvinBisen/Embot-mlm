...
const BonanzaPlan = () => {
  ...
  const [data, setData] = useState([
    {
      packageName: "Bronze Bonanza",
      description:
        "50 USD - 0.4% per day - 3 days, 30 days locking.",
      fromAmount: 50,
      toAmount: 99,
      perDay: "0.4%",
      monthly: "12%",
    ...
    {
      packageName: "Silver Bonanza",
      description:
        "100 USD - 0.5% per day - 5 days, 45 days locking.",
      fromAmount: 100,
      toAmount: 499,
      perDay: "0.5%",
      monthly: "15%",
    ...
    {
      packageName: "Gold Bonanza",
      description:
        "500 USD - 0.6% per day - 5 days, 90 days locking.",
      fromAmount: 500,
      toAmount: 999,
      perDay: "0.6%",
      monthly: "18%",
          ...
          <div className="bg-white rounded-2xl shadow-lg w-full max-w-xl p-6">
            ...
            <div className="space-y-5">
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                >
                  {isEditing ? "Save Changes" : "Add Bonanza"}
                </button>
              </div>
            </div>
          </div>
