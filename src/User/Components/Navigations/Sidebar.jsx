...
const navItems = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Report", path: "bonanza-plan-report", pro: false },
    ],
  },
  {
    icon: <TbReportMoney />,
    name: "Income Report",
    subItems: [
      { name: "Stake Income", path: "stake-income-report", pro: false },
      { name: "Lavel Income", path: "lavel-income-report", pro: false },
      { name: "Bonanza Income", path: "bonanza-income-report", pro: false },
    ],
  },
  {
    icon: <FaMoneyBillWave />,
